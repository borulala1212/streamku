...
def run_ml_app_diabetes():
	...
	with st.expander("Prediction result"):
		...
		model = load_model("data/logistic_regression_model_diabetes_21_oct_2020.pkl")
		...
		if prediction == 1:
			...
			pred_probanility_score = {"Negative DM Risk":pred_prob[0][0]*100,
